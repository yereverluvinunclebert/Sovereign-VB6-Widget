...
Private Sub lblGitHub_dblClick()
    ...
    If answer = vbYes Then
       Call ShellExecute(Me.hwnd, "Open", "https://github.com/yereverluvinunclebert/Sovereign-VB6-Widget", vbNullString, App.Path, 1)
    End If
End Sub
...
Private Sub sliGaugeSize_Change()
    ...
    btnSave.Enabled = True ' enable the save button
    If gblAllowSizeChangeFlg = True Then sovereignWidget.Zoom = sliGaugeSize.Value / 100
...
sliGaugeSize_Change_Error:
     ...
     MsgBox "Error " & Err.Number & " (" & Err.Description & ") in procedure sliGaugeSize_Change of Form sovereignPrefs"
End Sub
